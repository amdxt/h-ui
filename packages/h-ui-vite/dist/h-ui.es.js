import { defineComponent, createVNode, createTextVNode, openBlock, createElementBlock, Fragment, renderList, normalizeClass, normalizeStyle, createCommentVNode, toDisplayString, createBlock, resolveDynamicComponent } from "vue";
const props = {
  color: {
    type: String,
    default: "blue"
  ...
  return openBlock(), createElementBlock("div", null, [
    (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.tabs, (tab) => {
      return openBlock(), createElementBlock("span", {
        key: tab.name,
        class: normalizeClass(["tab", { active: tab.id === _ctx.valueInner }]),
        style: normalizeStyle({ lineHeight: `${_ctx.height}px`, fontSize: `${_ctx.fontSize}px` }),
        name: tab.id,
        onClick: ($event) => _ctx.handleClickTab(tab.id)
      }, [
        tab.isLoading ? (openBlock(), createElementBlock("i", _hoisted_2$1)) : createCommentVNode("", true),
...
function _sfc_render$1(_ctx, _cache) {
  return openBlock(), createElementBlock("div", {
    class: normalizeClass([_ctx.$huiGetNs()])
  }, [
    (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.options, (item, index) => {
      return openBlock(), createElementBlock("div", {
        ...
        item.slot ? (openBlock(), createBlock(resolveDynamicComponent(item.slot), { key: 0 })) : (openBlock(), createElementBlock("span", _hoisted_2, toDisplayString(item.name), 1))
      ], 14, _hoisted_1);
    }), 128))
  ], 2);
}
