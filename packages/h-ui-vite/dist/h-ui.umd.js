(function(global2, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("vue")) : typeof define === "function" && define.amd ? define(["exports", "vue"], factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, factory(global2.HUI = {}, global2.Vue));
  ...
  const Button = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$3]]);
  Button.install = (app) => {
    ...
    return vue.openBlock(), vue.createElementBlock("div", null, [
      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.tabs, (tab) => {
        return vue.openBlock(), vue.createElementBlock("span", {
          key: tab.name,
          class: vue.normalizeClass(["tab", { active: tab.id === _ctx.valueInner }]),
          style: vue.normalizeStyle({ lineHeight: `${_ctx.height}px`, fontSize: `${_ctx.fontSize}px` }),
          name: tab.id,
          onClick: ($event) => _ctx.handleClickTab(tab.id)
        }, [
          tab.isLoading ? (vue.openBlock(), vue.createElementBlock("i", _hoisted_2$1)) : vue.createCommentVNode("", true),
  ...
  const nsMixin = {
    ...
    beforeCreate() {
      console.log("123", this.$options.name, lodashExports.kebabCase(this.$options.name));
      this.$huiNsBlock = lodashExports.kebabCase(this.$options.name);
    }
  };
  const _sfc_main$1 = {
    mixins: [nsMixin],
  ...
  function _sfc_render$1(_ctx, _cache) {
    return vue.openBlock(), vue.createElementBlock("div", {
      class: vue.normalizeClass([_ctx.$huiGetNs()])
    }, [
      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.options, (item, index) => {
        return vue.openBlock(), vue.createElementBlock("div", {
          ...
          class: vue.normalizeClass([
            _ctx.$huiGetNsE("item"),
            _ctx.$huiGetNsEM("item", this.size),
            _ctx.getItemStyle(item.id, index, item.disabled)
          ]),
          style: vue.normalizeStyle(_ctx.styleObj),
          onClick: ($event) => _ctx.handleChange(item)
        }, [
          item.slot ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(item.slot), { key: 0 })) : (vue.openBlock(), vue.createElementBlock("span", _hoisted_2, vue.toDisplayString(item.name), 1))
        ], 14, _hoisted_1);
      }), 128))
    ], 2);
  }
  const RadioGroupButton = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1]]);
  RadioGroupButton.install = (app) => {
  ...
  const _sfc_main = {
    ...
    computed: {
      classes() {
        return [`h-color-block--${this.id}`, "h-color-block"];
      }
    }
  };
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    }, vue.toDisplayString($props.id), 3);
  }
  const ColorBlock = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
  ColorBlock.install = (app) => {
